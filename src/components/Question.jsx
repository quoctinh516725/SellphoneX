...
const hiddenPaths = ["/cart", "/place-order", "/payment"];
  ...
  return (
    <>
      {!hiddenPaths.includes(location.pathname) && (
        <div className="w-full sm:max-w-[1200px] mx-auto p-4  rounded-xl  my-10">
          <div className="bg-gray-100/70 rounded-xl p-4 shadow">
            {/* Header hướng dẫn */}
            ...
            <div className="p-4 bg-white rounded-xl mb-4">
              ...
              <p className="text-sm text-gray-400 font-semibold mb-2">
                SellphoneX sẽ phản hồi trong vòng 1 giờ. Nếu Quý khách gửi câu
              ...
              <div className="flex justify-center gap-5 mt-5">
                ...
                />
                <button className="text-xs sm:text-sm bg-primary hover:bg-red-600 text-white px-4 py-2 rounded-lg font-semibold text-nowrap ">
