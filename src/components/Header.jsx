      ...
      <div className="flex justify-between items-center">
        <div className="w-full md:max-w-[600px]  overflow-hidden">
          <ul class="flex whitespace-nowrap animate-marquee">
            <li class="mx-5 text-white font-semibold text-xs">
        ...
        <div className=" hidden md:flex items-center divide-x-2 divide-white/50">
          <Link to={"#"}>
            <p className="flex items-center gap-2 text-xs px-5  text-nowrap">
              <svg
              ...
              <span className="text-white font-semibold">Cửa hàng gần bạn</span>
            </p>
          </Link>
          <Link to={"#"}>
            <p className="flex items-center gap-2 text-xs px-5  text-nowrap">
          ...
          <Link to={"#"}>
            <p className="flex items-center gap-2 text-xs px-5  text-nowrap">
              ...
              <span className="text-white font-semibold">+84 123 456 789</span>
            </p>
          </Link>
        </div>
      </div>
